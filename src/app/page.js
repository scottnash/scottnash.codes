  ...
  return (
    <main className="flex min-h-screen flex-col justify-between p-0 sm:flex-row">
      ...
      <div className="flex flex-col sm:ml-[200px]">
        ...
        <p className="mx-[25px] mb-[25px]">I have many years experience as a senior Front-End Engineer, experienced with React, React Native, and many other frameworks, packages, as well as just working in vanilla JavaScript. I have worked on high profile projects as part of a large team, as well as smaller projects entirely on my own. Although my expertise lies most strongly on front-end development, I have experience on all aspects of web and mobile development, including design, UI/UX, analytics, working with APIs of a wide variety of flavors, databases, the construction of custom Content Management Systems, and just about every other aspect of taking a website or a mobile app from conception to production. I enjoy working both independently as well as part of a larger team where there is an opportunity to share knowledge and learn from others. I have never been on a team or a job where someone regretted my being there.</p>
