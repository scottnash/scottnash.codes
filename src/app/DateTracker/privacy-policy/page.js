...
export const metadata = {
  title: 'DateTracker Privacy Policy',
};

export default function PrivacyPolicy() {
  return (
    <main style={{ maxWidth: '700px', margin: '60px auto', padding: '0 24px', fontFamily: 'sans-serif', lineHeight: '1.7', color: '#cbd5e1' }}>
      <h1 style={{ color: '#f1f5f9', fontSize: '2rem', marginBottom: '4px' }}>DateTracker Privacy Policy</h1>
      <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}><em>Last updated: May 25, 2026</em></p>

      <p>
        DateTracker (&ldquo;the App&rdquo;) is a utility app developed by Scott Nash. This Privacy Policy explains how information
        is handled when you use the App.
      </p>

      <h2 style={{ color: '#7dd3fc', fontSize: '1.1rem', marginTop: '32px' }}>Data Collection</h2>
      <p>
        The App does not collect, store, transmit, or share any personal data. All data you enter (dates, labels, etc.)
